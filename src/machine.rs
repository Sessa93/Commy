...
mod tests {
    ...
    fn kernal_can_scan_keyboard_matrix_via_cia1_ports() {
        ...
        kernal[0x0000..0x0018].copy_from_slice(&[
            0xA9, 0xFF, 0x8D, 0x02, 0xDC, 0xA9, 0x00, 0x8D, 0x03, 0xDC, 0xA9, 0xFE, 0x8D, 0x00,
            0xDC, 0xAD, 0x01, 0xDC, 0x29, 0x04, 0xD0, 0xF7, 0xA9, 0x0E,
        ]);
        kernal[0x0018..0x001E].copy_from_slice(&[0x8D, 0x05, 0x04, 0x00, 0xEA, 0xEA]);
        kernal[0x1FFC] = 0x00;
        kernal[0x1FFD] = 0xE0;
